...
"""
Analysis: Part 2 - Comprehensive Social Cost Analysis Suite (Section 6 & Appendices)
"""

# --- ECONOMIC CONSTANTS (Constant 2021 Dollars) ---
...
ADJUSTED_FIXED_COSTS = {"legal": 444.65, "medical": 86.38, "therapy": 86.38, "medication": 53.96}
...
def main():
    ...
    # Updated output folder location
    ...
    # 1. Longitudinal Master Table
    print("Generating longitudinal results (Table 3)...")
